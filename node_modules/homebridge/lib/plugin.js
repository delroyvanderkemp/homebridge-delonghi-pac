...
class Plugin {
    ...
    getActiveDynamicPlatforms(platformName) {
...
not satisfy the current HomeBridge version of ${version_1.default()}. You may need to upgrade your installation of HomeBridge.`);
        }
