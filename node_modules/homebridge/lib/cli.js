...
module.exports = function cli() {
    ...
    commander_1.default
        ...
        .option("-C, --color", "force color in logging", () => _1.Logger.forceColor())
        .option("-D, --debug", "turn on debug level logging", () => _1.Logger.setDebugEnabled(true))
        ...
        .option("-T, --no-timestamp", "do not issue timestamps in logging", () => _1.Logger.setTimestampEnabled(false))
        .option("-U, --user-storage-path [path]", "look for homebridge user files at [path] instead of the default location (~/.homebridge)", path => _1.User.setStoragePath(path))
        .parse(process.argv);
    // Initialize HAP-NodeJS with a custom persist directory
    _1.HAPStorage.setCustomStoragePath(_1.User.persistPath());
    const options = {
